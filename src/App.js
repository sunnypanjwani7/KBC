  ...
  return (
    <div className="app_container">
     
      {
        ...
        username ? <><div className="main">  <div>Restart Game </div>
      {
        stop ? questionNumber - 1 === data.length ? (<div className="winner"> <div>🏆Congratulations!</div>You earned: <span> {earned} Points. </span> </div>) :  (<div className="earned">You earned: &#8377; {earned}</div>) : (<> <div className="top">
